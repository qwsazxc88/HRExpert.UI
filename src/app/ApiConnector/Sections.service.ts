...
export class SectionsService {
    ...
    private _list = ApiSettings.baseUrl+'/api/Modules';
	private _create = ApiSettings.baseUrl+'/api/Modules';
	private _read = ApiSettings.baseUrl+'/api/Modules';
	private _update = ApiSettings.baseUrl+'/api/Modules';
	private _delete = ApiSettings.baseUrl+'/api/Modules';	
	//List
    List() {       
