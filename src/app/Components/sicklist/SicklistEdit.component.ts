...
export class SicklistEditComponent implements OnInit {
	...
	OnModelReady()
	{
		...
		{
			this.Model.Data.SicklistBabyMindingType=this.SicklistBabyMindingTypes.filter(x=>x.Id==this.Model.Data.SicklistBabyMindingType.Id)[0];
		}
		if(this.Model.Data.SicklistPaymentPercent)
		{
			this.Model.Data.SicklistPaymentPercent=this.SicklistPaymentPercents.filter(x=>x.Id==this.Model.Data.SicklistPaymentPercent.Id)[0];
		}
		if(this.Model.Data.SicklistPaymentRestrictType)
		{
			this.Model.Data.SicklistPaymentRestrictType=this.SicklistPaymentRestrictTypes.filter(x=>x.Id==this.Model.Data.SicklistPaymentRestrictType.Id)[0];
		}
		if(this.Model.Data.SicklistType)
		{
			this.Model.Data.SicklistType=this.SicklistTypes.filter(x=>x.Id==this.Model.Data.SicklistType.Id)[0];
		}
